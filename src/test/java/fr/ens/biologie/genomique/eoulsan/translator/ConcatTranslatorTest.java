...
public class ConcatTranslatorTest {
  ...
  private final MultiColumnTranslator translA = new MultiColumnTranslator(ARRAY_FIELD_A);
  private final MultiColumnTranslator translB = new MultiColumnTranslator(ARRAY_FIELD_B);
