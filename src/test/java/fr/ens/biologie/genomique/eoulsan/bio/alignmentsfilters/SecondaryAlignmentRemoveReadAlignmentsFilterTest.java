 ...
 * SecondaryAlignmentRemoveReadAlignmentsFilter.
 * @author Laurent Jourdren
 * @since 2.1
 */
public class SecondaryAlignmentRemoveReadAlignmentsFilterTest {
  ...
  public void setUp() throws Exception {
    ...
    // recordSE2 unmapped
    this.recordSE2 =
        "HWI-EAS285_0001_'':1:1:1259:6203##0/1\t256\tchr4\t129576419\t72\t76M\t*\t0\t0"
            + "\tGACGGATCCGAGANANTGANNTGANAAGAGGNNNNNNNNNNNNNNAATTTGAGGACCNAAGGGATGCAGATGATGC"
            + "\tGEGEGE:@=BB><#7#AA:##@CC#CA9A8;##############=GGGGGDCDCDD#DDCGFGDGGGGBGGGGGG"
            + "\tXA:i:1\tMD:Z:13T1T3C0T3A2C3T0T0T0T0G0G0T0T0T0T0G0T0G0G12C18\tNM:i:21";
    // recordSE3 unmapped
    this.recordSE3 =
        "HWI-EAS285_0001_'':1:1:1259:6203##0/1\t272\tchr4\t129576419\t72\t76M\t*\t0\t0"
            + "\tGACGGATCCGAGANANTGANNTGANAAGAGGNNNNNNNNNNNNNNAATTTGAGGACCNAAGGGATGCAGATGATGC"
            + "\tGEGEGE:@=BB><#7#AA:##@CC#CA9A8;##############=GGGGGDCDCDD#DDCGFGDGGGGBGGGGGG"
            + "\tXA:i:1\tMD:Z:13T1T3C0T3A2C3T0T0T0T0G0G0T0T0T0T0G0T0G0G12C18\tNM:i:21";
    ...
    this.filter = new SecondaryAlignmentRemoveFlagReadAlignmentsFilter();
  }
  ...
  public void testGetName() {
    assertEquals("removesecondary", this.filter.getName());
  }
