...
import static fr.ens.biologie.genomique.eoulsan.steps.mapping.hadoop.HadoopMappingUtils.addParametersToJobConf;
import static fr.ens.biologie.genomique.eoulsan.steps.mapping.hadoop.ReadsFilterMapper.READ_FILTER_PARAMETER_KEY_PREFIX;
import static fr.ens.biologie.genomique.eoulsan.steps.mapping.hadoop.ReadsMapperHadoopStep.computeZipCheckSum;
import static fr.ens.biologie.genomique.eoulsan.steps.mapping.hadoop.ReadsMapperHadoopStep.setZooKeeperJobConfiguration;
import static fr.ens.biologie.genomique.eoulsan.steps.mapping.hadoop.SAMFilterReducer.MAP_FILTER_PARAMETER_KEY_PREFIX;
...
import fr.ens.biologie.genomique.eoulsan.steps.mapping.AbstractFilterAndMapReadsStep;
