...
public class ChIPSeqDataFormats {
  ...
  public static final DataFormat MACS2_RMODEL = registry.getDataFormatFromName("macs2rmodel");

  /** Gapped peak format. */
  public static final DataFormat GAPPED_PEAK = registry.getDataFormatFromName("gappedpeaks");

  /** Peaks XLS format. */
  public static final DataFormat PEAK_XLS = registry.getDataFormatFromName("peaksxls");
