...
public class EasyContrasts2 extends AbstractEasyContrasts {
  ...
  private void installScripts() throws IOException {
    ...
    for (String scriptName : R_SCRIPTS) {
      ...
      final String scriptContent =
          readFromJar(SCRIPTS_PATH_IN_JAR_FILE + scriptName);
   ...
   * @param value value of the parameter to add
   */
  private void addParameter(Map<String, String> map, String key,
      boolean value) {
  ...
  protected void execute(String prefix, DataFile workflowOutputDir)
    ...
    this.executor.executeRScript(commandLine(prefix), description,
        workflowOutputDir);
  }
   ...
   */
  EasyContrasts2(final RExecutor executor, final String stepId,
