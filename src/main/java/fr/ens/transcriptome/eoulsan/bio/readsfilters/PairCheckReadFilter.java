...
public class PairCheckReadFilter extends AbstractReadFilter {
  ...
  public boolean accept(final ReadSequence read1, final ReadSequence read2) {
    ...
    if (read1 == null)
      throw new NullArgumentException("Read1 is null");

    if (read2 == null)
      throw new NullArgumentException("Read2 is null");

    final String id1 = read1.getName();
    final String id2 = read2.getName();

    if (id1 == null)
      throw new NullArgumentException("Read1 id is null");

    if (id2 == null)
      throw new NullArgumentException("Read2 id is null");
