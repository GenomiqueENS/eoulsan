...
public class SampleMetadata extends AbstractMetadata implements Serializable {
   ...
   */
  public String getFastqFormat() {
    return get(FASTQ_FORMAT_KEY);
  }
   ...
   */
  public void setReads(String newReads) {
   ...
   */
  public void setFastqFormat(String newfastqFormat) {
    set(FASTQ_FORMAT_KEY, newfastqFormat);
  }
