...
public class DiffAnaOld {
  ...
  private String readStaticScript() {
    ...
    final InputStream is =
        this.getClass().getClassLoader().getResourceAsStream(ANADIFF_SCRIPT);
   ...
   */
  public DiffAnaOld(final Design design, final File expressionFilesDirectory,
