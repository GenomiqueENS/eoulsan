...
public class AnaDiffLocalMain {

  public static String PROGRAM_NAME = "anadiff";

  private static void anaDiff(final String designFilename) {
    ...
    try {
      ...
      // Write log file
      Common.writeLog(new File("anadiff.log"), startTime, log.toString());

    } catch (EoulsanException e) {
      System.err.println("Error while analysis data: " + e.getMessage());
      System.exit(1);
